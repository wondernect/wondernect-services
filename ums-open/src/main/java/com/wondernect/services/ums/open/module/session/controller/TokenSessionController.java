...
public class TokenSessionController {
    ...
    @RequestLogger(module = "token-session", operation = "request", description = "请求令牌")
    @ApiOperation(value = "请求令牌", httpMethod = "POST")
    ...
    @AuthorizeUserRole(authorizeType = AuthorizeType.EXPIRES_TOKEN, authorizeRoleType = AuthorizeRoleType.ONLY_AUTHORIZE)
    @RequestLogger(module = "token-session", operation = "delete", description = "删除令牌")
    @ApiOperation(value = "删除令牌", httpMethod = "POST")
    ...
    @AuthorizeUserRole(authorizeType = AuthorizeType.EXPIRES_TOKEN, authorizeRoleType = AuthorizeRoleType.ONLY_AUTHORIZE)
    @RequestLogger(module = "token-session", operation = "detail", description = "获取令牌", recordResponse = false)
    @ApiOperation(value = "获取令牌", httpMethod = "GET")
    @GetMapping(value = "/{token}/detail")
    public BusinessData<TokenResponseDTO> detail(
            @ApiParam(required = true) @NotBlank(message = "令牌不能为空") @PathVariable(value = "token", required = false) String token
    ) {
        return tokenSessionFeignClient.detail(token);
    }

    @AuthorizeUserRole(authorizeType = AuthorizeType.EXPIRES_TOKEN, authorizeRoleType = AuthorizeRoleType.ONLY_AUTHORIZE)
    @RequestLogger(module = "token-session", operation = "refresh", description = "刷新令牌")
    @ApiOperation(value = "刷新令牌", httpMethod = "POST")
    ...
    @AuthorizeUserRole(authorizeType = AuthorizeType.EXPIRES_TOKEN, authorizeRoleType = AuthorizeRoleType.ONLY_AUTHORIZE)
    @RequestLogger(module = "token-session", operation = "auth", description = "验证令牌", recordResponse = false)
    @ApiOperation(value = "验证令牌", httpMethod = "POST")
    ...
    @AuthorizeUserRole(authorizeType = AuthorizeType.EXPIRES_TOKEN, authorizeRoleType = AuthorizeRoleType.ONLY_AUTHORIZE)
    @RequestLogger(module = "token-session", operation = "page", description = "分页", recordResponse = false)
