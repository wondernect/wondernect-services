package com.wondernect.services.ums.module.mail.log;
 ...
 * FileName: UMSMailRequestLogService
 * Author: chenxun
 * Date: 2020/12/9 14:48
 * Description:
 */
@Service
public class UMSMailRequestLogService extends AbstractRequestLoggerRecordService {
