package com.wondernect.services.ums.module.rbac.controller;
 ...
 */
@RestController
@RequestMapping(value = "/v1/ums/rbac/role_menu_operation")
@Validated
@Api(tags = "权限管理服务-角色菜单操作关系")
public class RoleMenuOperationController {
    ...
    public BusinessData<RoleMenuOperationResponseDTO> detail(
        ...
        return roleMenuOperationFeignClient.detail(roleId, menuId, operationId);
    };
